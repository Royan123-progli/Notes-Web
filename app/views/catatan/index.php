        ...
        <div class="card">
            ...
            <div class="sticky-container">
                <?php if (count($data_catatan) > 0): ?>
                    <?php foreach ($data_catatan as $row): ?>
                        <div class="sticky-note">
                            ...
                            <div class="note-meta">
                                ...
                                <strong>Oleh:</strong> <?= htmlspecialchars($row['nama_admin']) ?> <br>
                                <strong>Dibuat Pada : </strong> <?= htmlspecialchars($row['created_at']) ?>
                            </div>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p style="text-align: center; color: #777; width: 100%;">Belum ada catatan.<br>Silakan tambah catatan baru!</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
