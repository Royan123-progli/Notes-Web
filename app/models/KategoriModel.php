...
class KategoriModel{
    ...
    public function getAll(){
        $query = "SELECT kategori.*, admin.username AS nama_admin FROM ".$this->table_name ." JOIN admin ON kategori.admin_id = admin.id ORDER BY kategori.id DESC";
...
public function getById($id) {
 ...
 public function delete($id){
    $query_catatan = "DELETE FROM catatan WHERE kategori_id = :id";
    $stmt_catatan = $this->conn->prepare($query_catatan);
    $stmt_catatan->bindParam(":id", $id);
